    ...
    progressSection: [
      {
        ...
        question: {
          ...
          percProgress: 34,
          title: "Over the past month, have you often experienced intense negative emotions in response to setbacks while monitoring your progress?",
          answers: [
    ...
    reviews: [
      {
        id: "review_1",
        rating: "5.0",
        review: "MyMentally has helped me spot patterns in my mood. I feel more in control every day",
        subtitle: "Racheal, 35, California"
      },
      {
        id: "review_2",
        rating: "4.9",
        review: "The insights are clear and practical. I've already made positive changes",
        subtitle: "Amy, 29, New York"
      },
      {
        id: "review_3",
        rating: "5.0",
        review: "Tracking my emotions is now effortless. MyMentally keeps me mindful and balanced",
