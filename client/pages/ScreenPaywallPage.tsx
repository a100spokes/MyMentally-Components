...
export default function ScreenPaywallPage() {
  ...
  const slideObject = {
    ...
    progressSection: [
      {
        ...
        progressText:
          "Fatigue, trouble sleeping, depression, or frequent mood changes.",
      ...
      },
      {
        ...
        progressText:
          "Anxiety, irritability, chronic exhaustion, or unexplained physical discomfort.",
      ...
      },
      {
        ...
        progressText:
          "Restlessness, vivid nightmares, or recurring distressing thoughts linked to past events.",
      ...
      },
      {
        ...
        progressText:
          "Emotional instability, relationship challenges, difficulty focusing, and trouble meeting goals.",
    ...
    graphSection: {
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/e27a917d89f19225b8d303be7d82a625e7af244f?width=776",
    },
    affectSection: {
      title: "How ADHD affects your daily life",
      description:
        "Based on your responses, we've calculated your ADHD symptom score.",
      ...
      options: [
        ...
        },
        {
          ...
          description:
            "Difficulty recalling details or keeping track of information.",
          icon: "https://",
        },
        {
          id: "section_3",
          ...
          description:
            "Rapid mood changes, irritability, and feeling emotionally drained.",
          icon: "https://",
        },
        {
          id: "section_4",
    ...
    choseUsSection: {
      ...
      description:
        "I finally feel like myself again. MyMentally gave me clarity, focus, and the confidence to handle daily challenges. - Ava",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/7ada459cccf5bdb36fe3a4fdf8c60a967a2892c7?width=776",
    },
    faqSection: {
      ...
      options: [
        {
          ...
          description:
            "We support online payment options, including credit cards, Apple Pay, and Google Pay.",
        },
        {
          id: "faq_2",
          title: "What happens after I finish the training?",
          description:
            "After completing the MyMentally ADHD program, 88% of participants reported noticeable improvements in managing anxiety, reducing stress, and feeling more in control of their daily life. You can also expect to strengthen your personal and professional relationships.",
        },
        {
          id: "faq_3",
          title: "Is my personal information safe?",
          description:
            "Yes. We do not store or collect any personal details provided during registration.",
        },
      ],
    },
  };
