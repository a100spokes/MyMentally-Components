...
const sampleProgressSlideObject = {
  ...
  data: {
    image: "https://api.builder.io/api/v1/image/assets/TEMP/057f9d69065de1d68a7b86d0227db077c1245d76?width=512",
    buttonText: "Next",
    title: "At MyMentally, we understand ADHD looks different for women",
    description: "Over 96,5% users manage ADHD more easily with our personalized plans",
