      ...
      <div className="w-full max-w-md bg-white rounded-2xl p-6 space-y-5">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-[#14B8A6] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              >
                <path
                  d="M9.61808 19.8333L4.07642 14.2916L5.46183 12.9062L9.61808 17.0624L18.5382 8.14228L19.9236 9.5277L9.61808 19.8333Z"
                  fill="white"
                />
              </svg>
            </div>
            <div className="flex-1 space-y-1">
              ...
              <p className="text-[#31345D] text-sm leading-relaxed">
                You have successfully started your journey towards a more
                resilient and trauma-free version of yourself.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-[#E0E7FF] rounded-full flex items-center justify-center flex-shrink-0">
              <div className="w-7 h-7 bg-[#5D88FF] rounded-full flex items-center justify-center">
                ...
                >
                  <path
                    d="M6.36665 14L2.56665 10.2L3.51665 9.25L6.36665 12.1L12.4833 5.98333L13.4333 6.93333L6.36665 14Z"
                    fill="white"
                  />
                </svg>
              </div>
            ...
            <div className="flex-1 space-y-1">
              <h3 className="text-[#31345D] font-bold text-base">Day 7</h3>
              <p className="text-[#31345D] text-sm leading-relaxed">
                Your trial will be converted to a full price unless it is
                canceled
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-dashed border-gray-300 pt-4">
          <div className="border-b border-dashed border-gray-300 pb-4 mb-4">
            <h2 className="text-[#31345D] font-bold text-lg mb-4">
              Total today
            </h2>
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                <div className="flex items-baseline gap-1">
                  <span className="text-[#31345D] font-bold text-base">
                    $1.43
                  </span>
          ...
          <p className="text-[#31345D] text-sm leading-relaxed">
            You'll have a full 7 days to experience how MyMentally can improve
            your life.
          </p>
        </div>
        ...
        <div className="border-t border-dashed border-gray-300 pt-4">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
              ...
              <div className="text-[#99A0A9] text-xs">
                Billed at $19.99/month
              </div>
            </div>
          </div>
        </div>
